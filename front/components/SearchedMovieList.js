...
//             return (
//                 <PosterCard key={v._source.DOCID._cdata} onMouseEnter={() => toggleSimpleInfo(v._source.DOCID._cdata, true)} onMouseLeave={() => toggleSimpleInfo(v._source.DOCID._cdata)} style={{ backgroundImage: `url(${v._source.posters._cdata}`}}>
//                     {v._source.title._cdata}
//                     <SimpleInfo key={v._source.DOCID._cdata} id={v._source.DOCID._cdata}>{v._source.keywords._cdata}</SimpleInfo>
//                 </PosterCard>
//                )
//         })}
//         </PosterCards>
